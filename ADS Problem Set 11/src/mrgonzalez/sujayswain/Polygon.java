...
class Polygon {
  ...
  /**
   * Collides method
   * <p>The goal of this method is to collides with other.</p>
   * 
   * @author Sujay Swain
   * @param other a polygon used as the other
   * @return a boolean after collidesing
   */
  public boolean collides(Polygon other) {
	  ...
	  for (int i = 0; i < points.length; i++) {
		  ...
		  if (other.contains(points[i])) c = true;
	  }

	  if (other.contains(position)) c = true;
	  return c;
  }
