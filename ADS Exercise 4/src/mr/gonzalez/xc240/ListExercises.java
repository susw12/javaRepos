...
import mr.gonzalez.xc240.MyArrayList;
...
public class ListExercises {
    ...
    public static void navarroExercises(String fileName) {
        ...
        MyArrayList<Integer> fileInts = new MyArrayList<>();
        ...
        MyArrayList<Integer> copyFileInts = new MyArrayList<>();
     ...
     * @author Sujay Swain
     */
    public static int maxLength(MyArrayList<String> listString) {
        int longestLength = 0;
     ...
     * @author Sujay Swain
     */
    /*public static MyArrayList<String> swapPairs(MyArrayList<String> original) {
     ...
     * @author Sujay Swain
     */
    public static MyArrayList<String> removeEvenLength(MyArrayList<String> list) {
     ...
     * @author Sujay Swain
     */
    public static MyArrayList<String> doubleList(MyArrayList<String> original) {
        MyArrayList<String> finalList = new MyArrayList<>();
     ...
     * @author Sujay Swain
     */
    public static MyArrayList<Integer> minToFront(MyArrayList<Integer> original) {
     ...
     * @author Sujay Swain
     */
    public static MyArrayList<String> removeDuplicates(MyArrayList<String> original) {
     ...
     * @author Sujay Swain
     */
    public static MyArrayList<String> stutter(MyArrayList<String> original, int k) {
        MyArrayList<String> finalList = new MyArrayList<>();
        if (k < 0) {
            original = finalList;
        }
     ...
     * @author Sujay Swain
     */
    public static MyArrayList<String> markLength4(MyArrayList<String> original) {
        for (int x = 0; x < original.size(); x++) {
     ...
     * @author Sujay Swain
     */
    public static MyArrayList<String> removeShorterStrings(MyArrayList<String> original) {
        MyArrayList<String> finalList = new MyArrayList<>();
     ...
     * @author Sujay Swain
     */
    public static MyArrayList<Integer> interleave(MyArrayList<Integer> a1, MyArrayList<Integer> a2) {
     ...
     * @author Sujay Swain
     */
    public static int closestPerfect(MyArrayList<Integer> a1) {
